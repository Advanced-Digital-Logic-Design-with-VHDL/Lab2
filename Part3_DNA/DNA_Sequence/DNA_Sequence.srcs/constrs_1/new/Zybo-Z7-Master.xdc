...
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { Clk_Btn}]; #IO_L9P_T1_DQS_34 Sch=sw[3]


##Buttons
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { Clk_Btn }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {Clk_Btn}]

#set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { Data_In }]; #IO_L24N_T3_34 Sch=btn[1]
...
#set_property -dict { PACKAGE_PIN T5    IOSTANDARD LVCMOS33 } [get_ports { ----- }]; #IO_L19P_T3_13 Sch=led5_g
