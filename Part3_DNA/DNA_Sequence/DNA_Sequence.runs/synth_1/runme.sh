...
HD_PWD='C:/Users/gaiya/Desktop/lab2-sd/DNA/DNA_Sequence/DNA_Sequence.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dna.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dna.tcl
