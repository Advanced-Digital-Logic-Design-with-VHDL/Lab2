...
HD_PWD='C:/Users/gaiya/Desktop/lab2-sd/DNA/DNA_Sequence/DNA_Sequence.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dna.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dna.tcl -notrace
